-- Fix create_pos_sale RPC function to match actual table schema
-- Date: 2025-11-16
-- Purpose: Remove location_id from orders insert (column doesn't exist)
...
BEGIN
  ...
  -- Create order (without location_id - doesn't exist in schema)
  INSERT INTO orders (
    order_number,
    vendor_id,
    session_id,
  ...
  LOOP
    INSERT INTO order_items (
      ...
      NULLIF(v_item->>'inventoryId', '')::UUID
    );
