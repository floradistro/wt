-- ============================================================================
-- FIX: Bulk adjustment idempotency check overwriting variables with NULL
-- ============================================================================
-- Same issue as 055 but in the bulk function
-- SELECT INTO sets ALL variables to NULL when no row found
-- Fix: Use RECORD type for idempotency check
-- ============================================================================
...
DECLARE
  ...
  v_existing_adjustment RECORD;  -- Use RECORD type to prevent NULL override
BEGIN
  ...
  LOOP
    BEGIN
      ...
      -- Check per-item idempotency using RECORD to prevent NULL override
...
'Processes multiple inventory adjustments atomically in a single transaction. Fixed NULL override bug by using RECORD type for idempotency check.';
