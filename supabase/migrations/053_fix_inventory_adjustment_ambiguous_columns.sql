-- ============================================================================
-- FIX: Ambiguous column references in process_inventory_adjustment
-- ============================================================================
-- Issue: Column names in RETURNS TABLE conflict with table column names
-- Fix: Add explicit table aliases to all SELECT statements
-- ============================================================================
...
BEGIN
  -- Check idempotency with explicit table alias
...
'Atomically processes inventory adjustments with idempotency. Fixed ambiguous column references by adding explicit table aliases.';
