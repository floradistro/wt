-- Migration: Fix bulk inventory adjustments to track staff member and audit_date
-- The bulk function was missing created_by and audit_date fields
  ...
  IF p_idempotency_key IS NOT NULL THEN
    ...
    IF EXISTS (
      ...
      SELECT
        ...
        ia.quantity_after,
        ia.quantity_change,
        COALESCE(p.inventory_quantity, 0) AS product_total_stock,
        TRUE AS success,
  ...
  LOOP
    BEGIN
      ...
      IF v_adjustment_id IS NOT NULL THEN
        ...
        SELECT COALESCE(p.inventory_quantity, 0) INTO v_total_stock
      ...
      -- Create adjustment record with created_by and audit_date
      ...
      RETURNING inventory_quantity INTO v_total_stock;
