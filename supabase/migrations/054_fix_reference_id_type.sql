-- ============================================================================
-- FIX: reference_id parameter type mismatch
-- ============================================================================
-- Issue: reference_id parameter is TEXT but table column is UUID
...
CREATE OR REPLACE FUNCTION process_inventory_adjustment(
  ...
  p_reference_id UUID DEFAULT NULL,  -- Changed from TEXT to UUID
...
'Atomically processes inventory adjustments with idempotency. Fixed reference_id type to UUID.';
